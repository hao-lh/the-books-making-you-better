...
Please feel free to send me [pull requests](https://github.com/hao-lh/the-books-making-you-better/pulls) or email to add links. ([GitHub][1])
...
* [C++ Concurrency in Action (2019,2nd)](https://www.manning.com/books/c-plus-plus-concurrency-in-action-second-edition) - Anthony Williams ([Manning Publications][4])
...
* [Learning Python (2013,5th)](https://learning-python.com/about-lp.html) - Mark Lutz ([Learning Python][5])
  ...
  * Summary: A thorough, foundations-first tutorial that aims to make you genuinely fluent in Python, not just productive quickly.
  * What you’ll learn: You can expect strong command of core syntax, data structures, and execution model, enabling you to learn advanced topics faster.

* [Python Cookbook (2013,3rd)](https://www.dabeaz.com/cookbook.html) - David Beazley and Brian K. Jones 

  * Summary: A “recipes” book that solves common real-world Python problems with concise, idiomatic patterns.
  * What you’ll learn: You’ll pick up practical techniques and modern idioms you can apply immediately across scripts, services, and data work.

* [Fluent Python (2021,2nd)](https://www.amazon.com) - Luciano Ramalho ([GitHub][1])
...
* [Programming Massively Parallel Processors: A Hands-on Approach (2022,4th)](https://www.amazon.com) - David B. Kirk and Wen-mei W. Hwu ([GitHub][1])
  ...
  * Summary: A structured, hands-on introduction to GPU programming and performance on massively parallel hardware.
  * What you’ll learn: You’ll learn GPU execution and memory models, plus optimization fundamentals that matter for real throughput gains.

* [CUDA by Example: An Introduction to General-Purpose GPU Programming (2010)](https://www.amazon.com) - Jason Sanders and Edward Kandrot ([GitHub][1])

  * Summary: A practical, example-driven entry point for CUDA programming with incremental complexity.
  * What you’ll learn: You’ll gain the ability to write kernels, manage device memory, and debug performance bottlenecks in approachable steps.

* [CUDA for Engineers: An Introduction to High-Performance Parallel Computing (2014)](https://www.amazon.com) - Duane Storti and Mete Yurtoglu ([GitHub][1])
...
* [CS224n: Natural Language Processing with Deep Learning](https://web.stanford.edu/class/cs224n/) - Chris Manning (Stanford University) ([GitHub][1])
  ...
  * Summary: A graduate-level NLP course that builds modern understanding from embeddings to Transformers and contemporary NLP systems.
  * What you’ll learn: You’ll learn core NLP modeling techniques and practical training/evaluation considerations that transfer directly to LLM work.
...
* [Machine Learning](https://www.coursera.org/learn/machine-learning) - Andrew Ng (Stanford University) ([GitHub][1])
  ...
  * Summary: A widely used introductory course that explains core ML concepts with a clear, applied orientation.
  * What you’ll learn: You’ll learn the fundamentals of supervised learning, key algorithms, and practical intuition for model training and evaluation.

* [CS231n: Convolutional Neural Networks for Visual Recognition](https://cs231n.stanford.edu/) - Fei-Fei Li (Stanford University) ([GitHub][1])

  * Summary: A deep learning for vision course that emphasizes CNN architectures, training tricks, and representation learning.
  * What you’ll learn: You’ll learn how modern vision models are built and trained, and how to reason about architectures and optimization choices.

* [Deep Learning Specialization](https://www.coursera.org/specializations/deep-learning) - [deeplearning.ai](https://www.deeplearning.ai/) ([Coursera][33])

  * Summary: A structured multi-course program covering the practical foundations of deep learning across common architectures.
  * What you’ll learn: You’ll learn how to build and tune DNNs/CNNs/RNNs/Transformers and develop engineering instincts for troubleshooting training.

#### Computer Systems<a name="courses-computer-systems" />

* [The Missing Semester of Your CS Education (2020)](https://missing.csail.mit.edu/) - Anish, Jon, and Jose ([GitHub][1])

  * Summary: A tooling-focused course that teaches the practical “day-to-day” skills often missing from formal CS curricula.
  * What you’ll learn: You’ll learn shell, scripting, version control, debugging, and productivity tools that compound across every technical project.

## Papers<a name="papers" />
#### Deep Learning<a name="papers-deep-learning" />

* He, Kaiming, et al. “[Deep residual learning for image recognition](https://openaccess.thecvf.com/content_cvpr_2016/html/He_Deep_Residual_Learning_CVPR_2016_paper.html).” Proceedings of the IEEE conference on computer vision and pattern recognition. 2016. ([GitHub][1])

  * Summary: Introduces residual connections that make very deep neural networks easier to optimize and significantly improve accuracy.
  * What you’ll learn: You’ll learn why skip connections stabilize training and how modern architectures reuse this idea for depth, efficiency, and scalability.

* Vaswani, Ashish, et al. “[Attention is all you need](https://arxiv.org/abs/1706.03762).” Advances in neural information processing systems 30 (2017). ([GitHub][1])

  * Summary: Proposes the Transformer, replacing recurrence with self-attention to model sequences efficiently and effectively.
  * What you’ll learn: You’ll learn the core mechanism behind modern LLMs—multi-head self-attention, positional encoding, and the scaling-friendly architecture that followed.
## Star History
...
[1]: https://github.com/hao-lh/the-books-making-you-better "GitHub - hao-lh/the-books-making-you-better: This repo is a curated library to help you achieve a deeper understanding of what drives success and continuous improvement. Dive in, and discover content that can expand your thinking, sharpen your expertise, and fuel you drive better, whether you’re exploring new fields, honing in-demand skills, or simply looking for fresh perspectives."
[2]: https://www.stroustrup.com/4th.html "Stroustrup: The C++ Programming Language (4th Edition)"
[3]: https://www.informit.com/store/c-plus-plus-primer-9780321714114 "C++ Primer, 5th Edition | InformIT"
[4]: https://www.manning.com/books/c-plus-plus-concurrency-in-action-second-edition "C++ Concurrency in Action, Second Edition - Anthony Williams"
[5]: https://learning-python.com/about-lp.html "About \"Learning Python\""
[6]: https://csapp.cs.cmu.edu/?utm_source=chatgpt.com "Computer Systems: A Programmer's Perspective - Carnegie ..."
[7]: https://www.mheducation.com/highered/product/introduction-computing-systems-bits-gates-c-c-beyond-patt-patel/M9781260150537.html "Introduction to Computing Systems: From Bits & Gates to C/C++ & Beyond"
[8]: https://pages.cs.wisc.edu/~remzi/OSTEP/ "Operating Systems: Three Easy Pieces"
[9]: https://www.man7.org/tlpi/ "The Linux Programming Interface"
[10]: https://martin.kleppmann.com/2017/03/27/designing-data-intensive-applications.html "Designing Data-Intensive Applications — Martin Kleppmann’s publications"
[11]: https://www.pearson.com/us/higher-education/program/Lay-Linear-Algebra-and-Its-Applications-plus-New-My-Lab-Math-with-Pearson-e-Text-Access-Card-Package-5th-Edition/PGM2547338.html?tab=resources "Search results: Lay Linear-Algebra-and-Its-Applications-plus-New-My-Lab-Math-with-Pearson-e-Text-Access-Card-Package-5th-Edition | Pearson US"
[12]: https://math.mit.edu/~gs/linearalgebra/ "Introduction to Linear Algebra"
[13]: https://linear.axler.net/ "Linear Algebra Done Right"
[14]: https://link.springer.com/book/10.1007/978-3-642-30994-6 "Linear Algebra and Geometry | Springer Nature Link (formerly SpringerLink)"
[15]: https://www.cambridge.org/core/books/probability-theory/9CA08E224FF30123304E6D8935CF1A99?utm_source=chatgpt.com "Probability Theory"
[16]: https://algs4.cs.princeton.edu/home/ "
Algorithms, 4th Edition by Robert Sedgewick and Kevin Wayne"
[17]: https://www.algorist.com/ "The Algorithm Design Manual"
[18]: https://research.microsoft.com/en-us/um/people/cmbishop/prml/index.htm "Home - Microsoft Research"
[19]: https://www.cs.ubc.ca/~murphyk/MLbook/ "Machine learning textbook"
[20]: https://probml.github.io/pml-book/book2.html "probml.github.io"
[21]: https://onlinelibrary.wiley.com/doi/10.1002/bimj.201500224?utm_source=chatgpt.com "An Introduction to Statistical Learning with Applications. ..."
[22]: https://web.stanford.edu/~hastie/ElemStatLearn/ "Elements of Statistical Learning: data mining, inference, and prediction.
2nd Edition."
[23]: https://charuaggarwal.net/ "  Charu Aggarwal "
[24]: https://www.manning.com/books/grokking-deep-learning "Grokking Deep Learning - Andrew W. Trask"
[25]: https://www.manning.com/books/deep-learning-with-python "Deep Learning with Python - François Chollet"
[26]: https://www.oreilly.com/library/view/hands-on-machine-learning/9781492032632/ "Hands-On Machine Learning with Scikit-Learn, Keras, and TensorFlow, 2nd Edition [Book]"
[27]: https://www.charuaggarwal.net/neural.htm "   Neural Networks and Deep Learning "
[28]: https://www.deeplearningbook.org/ "Deep Learning"
[29]: https://www.oreilly.com/library/view/generative-deep-learning/9781492041931/ "Generative Deep Learning [Book]"
[30]: https://www.manning.com/books/build-a-large-language-model-from-scratch "Build a Large Language Model (From Scratch) - Sebastian Raschka"
[31]: https://www.robots.ox.ac.uk/~vgg/hzbook/ "
Multiple View Geometry in Computer Vision<BR>Second Edition
"
[32]: https://www.amazon.com/Probabilistic-Graphical-Models-Principles-Computation/dp/0262013193?utm_source=chatgpt.com "Probabilistic Graphical Models: Principles and Techniques ..."
[33]: https://www.coursera.org/specializations/deep-learning "Deep Learning | Coursera"
